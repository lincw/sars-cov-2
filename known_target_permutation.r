...
par(ps = 8)
plot(dens, xlim = c(0, 70), col = "#BEBEBE", freq = TRUE, border = NA, las = 1, xlab = "", ylab = "", yaxt = "n", main = "Known host targets")
...
arrows(binary_pre, 350, binary_pre, 0, col = "#922687", lwd = 2, length = 0.05, angle = 15)
text(binary_pre - 20, 500, label = paste("observed = ", binary_pre, "\np =", sign_pre), cex = 0.7, pos = 4)
dev.off()
