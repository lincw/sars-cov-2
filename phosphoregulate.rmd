...
binary_human <- binary[binary$group == "human", "node"]
...
paste0("classic viral ORF: ", 27)
paste0("fBFG search space: ", 28 * length(fbfg))
paste0("classic Y2H (hORF) search space, vPrey (AD), hBait (DB): ", 27 * length(horf))
...
paste0("Fraction of total: ", 100 * round((25 * table(horf %in% fbfg)[2])/(30 * length(tot_space)), 4), "%")
```
