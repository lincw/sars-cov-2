...
binary <- read.csv("~/Documents/INET-work/virus_network/toSummarize/HuSCI_edge.csv", header = T)
...
for (i in 1:10000) {
    ...
    write.csv(as_data_frame(random_g), file = paste0("HuSCI_randomized_network_", i, ".csv"), row.names = FALSE)
}
